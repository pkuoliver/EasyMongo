...
function render_manual_items() {
	$items = array(
		'<a href="https://www.mongodb.com/docs/manual/reference/operator/" target="_blank">' . rock_lang("querying") . '</a>',
		'<a href="https://www.mongodb.com/docs/manual/tutorial/update-documents/" target="_blank">' . rock_lang("updating") . '</a>',
		'<a href="https://www.mongodb.com/docs/manual/reference/command/" target="_blank">' . rock_lang("commands") . '</a>',
		'<a href="https://www.mongodb.com/docs/php-library/current/" target="_blank">PHP Library</a>',
		'<a href="https://www.php.net/manual/en/set.mongodb.php" target="_blank">' . rock_lang("phpmongo") . '</a>',
...
function render_doc_menu($dbName, $collectionName, $docId, $docIndex) {
	$menuItems = array(
		...
		array (  "action" => "collection.none", "name" => rock_lang("expand"), "attr.id" => "expand_{$docIndex}", "attr.onclick" => "expandText('{$docIndex}');return false;" ),
	);
