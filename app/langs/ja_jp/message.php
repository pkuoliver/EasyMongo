...
$message["databases"] = "データベース";
$message["processlist"] = "Processlist";
$message["command"] = "コマンド";
$message["execute"] = "実行";
...
$message["master_slave"] = "マスター/スレーブ";
$message["query"] = "クエリー";
$message["refresh"] = "リフレッシュ";
$message["insert"] = "挿入";
$message["add"] = "Add";
$message["clear"] = "Clear";
$message["delete"] = "削除";
...
$message["export"] = "輸出";
$message["import"] = "インポート";
$message["transfer"] = "転送";
$message["sock"] = "Socket";
$message["drop"] = "ドロップ";
$message["more"] = "もっと";
$message["rename"] = "リネーム";
$message["indexes"] = "インデックス";
$message["properties"] = "プロパティ";
$message["validate"] = "検証";
$message["repair"] = "修理";
$message["all"] = "All";
$message["authentication"] = "認証";
...
/** Top bar **/
$message["tools"] = "ツール";
$message["manuals"] = "マニュアル";
$message["logout"] = "ログアウト";

$message["switch_hosts"] = "Switch Hosts";

/** About **/
$message["about_content"] = '<strong class="big">EasyMongo</strong> is a MongoDB administration tool, written in PHP.
