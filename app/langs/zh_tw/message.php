...
$message["month"] = "月";
$message["alive"] = "有效期";
$message["authenticate"] = "认证";

/** Connection **/
$message["can_not_connect"] = "MongoDB連接錯誤: %s. 請檢查配置是否正確.";
$message["can_not_auth"] = "MongoDB认证失败. 请检查用户名和密码.";
...
$message["server"] = "服務器";
$message["status"] = "狀態";
$message["databases"] = "數據庫";
$message["processlist"] = "進程";
$message["command"] = "命令";
$message["execute"] = "代碼執行";
...
$message["update"] = "更新";
$message["duplicate"] = "復制";
$message["text"] = "文本";
$message["expand"] = "展开";
$message["collapse"] = "收起";
$message["yes"] = "Yes";
$message["no"] = "No";
$message["statistics"] = "統計";
$message["export"] = "導出";
$message["import"] = "導入";
$message["transfer"] = "克隆";
$message["sock"] = "Socket";
...
$message["rename"] = "更名";
$message["indexes"] = "索引";
$message["properties"] = "屬性";
$message["validate"] = "校驗";
$message["repair"] = "修復";
$message["all"] = "All";
$message["authentication"] = "用戶";
$message["profile"] = "調試信息";
$message["create_collection"] = "創建集合";
$message["create_collection_full"] = "創建集合";
$message["create_database"] = "創建數據庫";
$message["save"] = "保存";
$message["back"] = "返回";
...
$message["build_info"] = "编译信息";
$message["kill"] = "Kill";
$message["killop"] = "是否要杀掉当前op";
...
$message["data"] = "Data";
$message["validarray"] = "数据必须为有效的PHP数组, 例如:";
$message["responseserver"] = "服务器响应:";
$message["db"] = "DB";
$message["gotodbs"] = "Go to databases";
$message["dropdatabase"] = "删除数据库";
...
$message["download"] = "下载?";
$message["compressed"] = "已压缩";
$message["rowsexported"] = "行已导出";
$message["createnewcollection"] = "创建新表";
$message["target"] = "目标";
$message["host"] = "Host";
$message["port"] = "Port";
$message["copyindexes"] = "复制索引?";
$message["confirm"] = "确认";
$message["fields"] = "字段";
$message["other_fields"] = "其他字段";
$message["unique"] = "唯一";
$message["key"] = "建";
$message["operation"] = "操作";
$message["removeduplicates"] = "重复键值";
$message["duplicateskeyinfo"] = "如果有重复的key, 创建索引将会失败.";
$message["listdbcommands"] = "List of database commands";
$message["format"] = "格式";
$message["execute_command"] = "执行Command";
$message["validate"] = "校驗";
$message["dropifexists"] = "如果存在则删除?";
$message["warningprops"] = "<strong>注意</strong>: 为了更改Collection属性, 我们会先创建一个新的collection，然后从原来的collection复制数据到新的collection中，最后删除原来的collection。当数据量较大时，本操作会相当耗时！";
$message["copycollection"] = "复制Collection";
$message["to"] = "To";
...
/** Add user **/
$message["users"] = "用户";
$message["adduser"] = "添加用户";
$message["username"] = "用户名";
$message["confirm_pass"] = "确认密码";
$message["readonly"] = "只读?";
$message["addreplace"] = "添加或替换";
...
$message["submit_query"] = "查詢";
$message["explain"] = "分析";
$message["clear_conditions"] = "清除條件";
$message["rows_per_page"] = "每頁顯示數";
$message["action"] = "動作";
$message["limit"] = "條數";
$message["new_field"] = "新字段";

/** Index Creation **/
$message["warningindex"] = "確定要刪除本索引嗎";
$message["createindex"] = "創建普通索引";
$message["create_2d_index"] = "創建2D索引";
...
/** About **/
$message["about_content"] = '<strong class="big">EasyMongo</strong>是可視化的MongoDB管理工具。支持Mongodb3.0+，以及php5.6以上所有版本。
...
<p>相關文檔:<ul>
<li><a href="http://easymongo.com/wiki/changeLog" target="_blank">更新日誌</a></li>
...
<li><a href="http://easymongo.com/donation" target="_blank">捐贈<br/><img src="http://www.paypal.com/en_US/i/btn/x-click-but04.gif"/></a></li>
<li><a href="https://github.com/pkuoliver/EasyMongo/issues" target="_blank">報告問題</li>
</ul></p>
';
