...
$message["master_slave"] = "Replication";
$message["query"] = "Query";
...
/** About **/
$message["about_content"] = '<strong class="big">EasyMongo</strong> is a MongoDB administration tool, written in PHP, supports Mongodb3.0+, and all php versions above 5.6.
