...
class RMongo {
	...
	const DB_TYPE_MAP = ['root' => 'array', 'document' => 'array', 'array' => 'array'];
	...
	public function __construct($server, array $options = array()) {
		...
		$this->_mongo = new MongoDB\Client($server, $options, ['typeMap'=>RMongo::DB_TYPE_MAP]);
	}
	...
	public function listDBs() {
		return $this->_mongo->listDatabases();
	}
	...
	public function selectDB($db) {
		return $this->_mongo->selectDatabase($db);
	}
