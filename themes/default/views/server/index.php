...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="80%">
	<tr>
...
<table bgcolor="#cccccc" cellpadding="2" cellspacing="1" width="80%">
	<tr>
		<th colspan="2"><?php hm("startup_log"); ?> (<a href="<?php h(url("collection.index", array( "db" => "local", "collection" => "startup_log" ))); ?>">local.startup_log</a>)</th>
	</tr>
	<?php foreach ($startupLogs as $master):?>
	<tr bgcolor="#cfffff">
